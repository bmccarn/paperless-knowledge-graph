    ...
    async def audit_answer_units(self, question: str, units: list[dict], spans: list[dict], plan: dict) -> dict | None:
        ...
        return await self._json_agent(
            ...
            system_prompt=(
                ...
                "Evidence selection reports known eligible alternative documents that could not be supplied. "
                "Do not claim a latest/current or cohort-wide comparison covers those omitted records. "
                "A direct comparison of explicitly identified records and independent dated source observations "
                "do not establish a cohort-wide result. Selection opportunities are retrieval diagnostics, not proof. "
