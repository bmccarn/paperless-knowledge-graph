...
Status: proposed from an actual production browser reproduction, before implementation.
...
wheel or pointer-down within the canvas before initial fitting. Keep initial fit
...
cooldown completes; record actual canvas zoom, wait through the startup settling
